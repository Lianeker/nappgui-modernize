...
static Layout *i_vectors_layout(void)
{
    ...
    layout_halign(layout1, 0, 0, ekHCENTER);
    layout_halign(layout1, 1, 0, ekHCENTER);
    layout_halign(layout1, 2, 0, ekHCENTER);
    layout_halign(layout1, 0, 2, ekHCENTER);
    layout_halign(layout1, 1, 2, ekHCENTER);
    layout_halign(layout1, 2, 2, ekHCENTER);
...
static Layout *i_lengths_layout(void)
{
    ...
    label_align(label7, ekHRIGHT);
    label_align(label8, ekHRIGHT);
    label_align(label9, ekHRIGHT);
    label_align(label10, ekHRIGHT);
    label_align(label11, ekHRIGHT);
    label_align(label12, ekHRIGHT);
    layout_hsize(layout, 1, 40);
    layout_hmargin(layout, 0, 5);
    layout_halign(layout, 1, 0, ekHJUSTIFY);
    layout_halign(layout, 1, 1, ekHJUSTIFY);
    layout_halign(layout, 1, 2, ekHJUSTIFY);
    layout_halign(layout, 1, 3, ekHJUSTIFY);
    layout_halign(layout, 1, 4, ekHJUSTIFY);
    layout_halign(layout, 1, 5, ekHJUSTIFY);
