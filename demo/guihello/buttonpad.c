...
static Layout *i_flatpadding_layout(PData *data)
{
    ...
    button_text(button1, "Open");
    button_text_alt(button1, "Open File");
    button_text(button2, "Search");
    button_text_alt(button2, "Search File");
    button_text(button3, "Add");
    button_text_alt(button3, "Delete File");
    button_image(button1, gui_image(FOLDER24_PNG));
    button_image_alt(button1, gui_image(DISK24_PNG));
    button_image(button2, gui_image(FOLDER24_PNG));
...
Panel *buttonpad(void)
{
    ...
    label_text(label3, "Flat toggle padding");
